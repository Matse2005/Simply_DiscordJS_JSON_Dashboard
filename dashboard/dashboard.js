...
module.exports = async (client) => {
  ...
  */
  ...
  fs.writeFile("./json/prefix.json", JSON.stringify(prefixJson), (err) => {
    ...
    renderTemplate(res, req, "settings.ejs", { guild, settings: prefixJson[guild.id], alert: null });
  });
    ...
    app.post("/dashboard/:guildID", checkAuth, async (req, res) => {
        ...
        prefixJson[guild.id].prefix = req.body.prefix;
        ...
        renderTemplate(res, req, "settings.ejs", { guild, settings: prefixJson[guild.id], alert: "Your settings have been saved." });
    });
